...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	generate_ore("lulzpack:stone_with_ununterx", "default:stone", minp, maxp, seed+0, 1/24/24/24, 12, 64, -31000, -240)
	generate_ore("lulzpack:stone_with_ununbet", "default:stone", minp, maxp, seed+0, 1/24/24/24, 12, 64, -31000, -240)
	generate_ore("lulzpack:stone_with_ununsen", "default:stone", minp, maxp, seed+0, 1/24/24/24, 12, 32, -31000, -320)
end)
